...
export default function DashboardTransparansiPage() {
  ...
  const loadStatistics = async () => {
    setIsLoading(true);
    try {
      const res = await apiCall(API_ENDPOINTS.stats.public);
  ...
  const statusChartData = useMemo(() => {
    return Object.entries(stats.reportsByStatus)
    ...
    <div className="container py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Pantau progress penanganan bencana dan infrastruktur secara real-time. Data transparan
